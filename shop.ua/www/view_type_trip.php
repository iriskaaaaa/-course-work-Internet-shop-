...
switch($type_trip){
        case 'active';
        $type_of_trip= "WHERE id_type_of_story=1";
        break;
        
        case 'passive';
        $type_of_tripp="WHERE id_type_of_story=2";
        break;
        
        case 'family';
       $type_of_trip="WHERE id_type_of_story=3";
        break;
...
$myrow=mysql_fetch_array($result);
    ...
    echo'<div class="btn-group-vertical filtr-city">
<div class="btn-group">
...
<p class="navbar-text text_sort">Вид отдыха</p>
  <a href="index.php?type_trip=all_type"><button type="button" class="btn btn-default">Все виды</button></a>
  <a href="index.php?type_trip=active"><button type="button" class="btn btn-default">Активный</button></a>
  <a href="index.php?type_trip=passive"><button type="button" class="btn btn-default">Пассивный</button></a>
  <a href="index.php?type_trip=family"><button type="button" class="btn btn-default">Семейный</button></a>
</div>
    	</div>
    ...
    if($temp[0]>0){
        $result=mysql_query("SELECT * FROM story $type_of_trip ORDER BY $sorting LIMIT $start, $num",$link);
        if(mysql_num_rows($result)>0){
            $row=mysql_fetch_array($result);
            do{
