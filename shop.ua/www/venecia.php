...
<ul id="sort">
<li>Сортировать:</li>
<li><a href="venecia.php?sort=price-desc">От дорогих к дешовым</a></li>
<li><a href="venecia.php?sort=price-asc">От дешовых к дорогим</a></li>
</li>
</ul>
<div id="tovar1">

<?php
	$result=mysql_query("SELECT * FROM product WHERE brand='Venezia' ORDER BY $sorting",$link);
