...
$('#button-send-bad').click(function(){
                
  
   var bad = $("#comment_review").val();
   var rid = $("#button-send-bad").attr("rid");
    ...
    if (comment_review == '1')
      {
         $("#button-send-bad").hide();
         $("#reload-img").show();
                  
      $.ajax({
         type: "POST",
         url: "/include/add_moderat.php",
         data: "bad="+bad+"&id="+rid,
         dataType: "html",
         cache: false,
         success: function() {
...
$('#bad_comment').click(function(){
   ...
   var rid = $("#bad_comment").attr("rid");
      ...
      $.ajax({
         ...
         cache: false,
         success: function() {
           $("#bad_comment").css("borderColor","#FDB6B6");
         }
         });  
