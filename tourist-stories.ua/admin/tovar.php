...
if($_SESSION['auth_admin']=="yes_auth"){
    ...
    $_SESSION['urlpage']="<a href='index.php'>Главная</a> \ <a href='reviews.php'>Отзыввы</a>";
...
<?php
    ...
    $all_count=mysql_query("Select count_()",$link);
    $row = mysql_fetch_row($all_count);
...
<div id="block-info">
<p id="count-style">Всего товаров - <strong><?php echo $row[0]?></strong></p>
